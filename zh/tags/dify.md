...
| 技能 | 仓库 | 简介 | ⭐ | ⬇️ | 更新 | 标签 |
| - | - | - | -: | -: | - | - |
| [orpc-contract-first](https://github.com/langgenius/dify/blob/main/.agents/skills/orpc-contract-first/SKILL.md) | [langgenius/dify](https://github.com/langgenius/dify) | 用于在 Dify 前端实现 oRPC 合约优先 API 模式的技能。 | 131K | 635 | 2026-03-02 | [API](api.md), [前端 (frontend)](frontend.md), [contract 测试 (contract-testing)](contract-testing.md), [dify (dify)](dify.md), [tanstack (tanstack)](tanstack.md) |
| [dify-dsl-generator](https://github.com/wwwzhouhui/skills_collection/blob/main/dify-dsl-generator/SKILL.md) | [wwwzhouhui/skills_collection](https://github.com/wwwzhouhui/skills_collection) | 根据业务需求生成 Dify 工作流 DSL/YAML 文件。 | 126 | 123 | 2026-03-01 | [工作流 (workflows)](workflows.md), [代码生成](code-generation.md), [dify (dify)](dify.md), [dsl (dsl)](dsl.md) |
