...
| - | - | - | -: | -: | - | - |
| [transformers](https://github.com/davila7/claude-code-templates/blob/main/cli-tool/components/skills/scientific/transformers/SKILL.md) | [davila7/claude-code-templates](https://github.com/davila7/claude-code-templates) | A skill for working with pre-trained transformer models in NLP, computer vision, and multimodal tasks. | 22K | 163 | 2026-03-05 | [machine-learning](machine-learning.md), [natural-language-processing](natural-language-processing.md), [transformers](transformers.md), [huggingface-transformers](huggingface-transformers.md) |
| [hqq-quantization](https://github.com/davila7/claude-code-templates/blob/main/cli-tool/components/skills/ai-research/optimization-hqq/SKILL.md) | [davila7/claude-code-templates](https://github.com/davila7/claude-code-templates) | Quantize LLMs to 4/3/2-bit precision without calibration data, suitable for fast workflows with vLLM or HuggingFace. | 22K | 131 | 2026-03-05 | [llm-optimization](llm-optimization.md), [vllm](vllm.md), [huggingface-transformers](huggingface-transformers.md) |
