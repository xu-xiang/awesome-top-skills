...
| - | - | - | -: | -: | - | - |
| [transformers](https://github.com/davila7/claude-code-templates/blob/main/cli-tool/components/skills/scientific/transformers/SKILL.md) | [davila7/claude-code-templates](https://github.com/davila7/claude-code-templates) | A skill for working with pre-trained transformer models in NLP, computer vision, and multimodal tasks. | 22K | 159 | 2026-03-04 | [machine-learning](machine-learning.md), [natural-language-processing](natural-language-processing.md), [transformers](transformers.md), [huggingface-transformers](huggingface-transformers.md) |
